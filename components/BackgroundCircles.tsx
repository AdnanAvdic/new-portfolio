...
export default function BackgroundCircles({}: Props) {
  return (
    <motion.div
      ...
      className="relative flex justify-center items-center snap-center"
    >
      ...
      <div
        className="absolute border border-[#F7AB0A] opacity-20 rounded-full h-[210px] w-[210px]
      md:h-[700px] md:w-[700px] mt-52 animate-pulse "
      />
